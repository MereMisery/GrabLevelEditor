...
namespace RuntimeGizmos
{
	...
	public class TransformGizmo : MonoBehaviour
	{
		...
		public GameObject LastSelTarget;

		public TMP_Dropdown Typelist;
		public TMP_Dropdown Shapelist;
		public TMP_InputField SignText;
		public TMP_InputField RadiusText;
		public TMP_InputField RespawnText;
		public TMP_InputField StableText;
        ...
        public void Shapeinfochange()
        {
			float stable = float.Parse(StableText.text);
			float respawn = float.Parse(RespawnText.text);
			float stabletime = float.Parse(StableText.text);
			float radiussize = float.Parse(RespawnText.text);

			if (Shapelist.GetComponent<TMP_Dropdown>().value == 0)
			{
				LastSelTarget.GetComponent<descripter>().shape = "start";
				LastSelTarget.GetComponent<descripter>().radius = radiussize;
				LastSelTarget.GetComponent<MeshFilter>().mesh = StartEndMesh;
				LastSelTarget.GetComponent<Renderer>().material = StartMat;
				LastSelTarget.name = "Start";
			}
			else if (Shapelist.GetComponent<TMP_Dropdown>().value == 1)
			{
				LastSelTarget.GetComponent<descripter>().shape = "finish";
				LastSelTarget.GetComponent<descripter>().radius = radiussize;
				LastSelTarget.GetComponent<MeshFilter>().mesh = StartEndMesh;
				LastSelTarget.GetComponent<Renderer>().material = EndMat;
				LastSelTarget.name = "Finish";
			}
			else if (Shapelist.GetComponent<TMP_Dropdown>().value == 3)
			{
				LastSelTarget.GetComponent<descripter>().shape = "Cube";
				LastSelTarget.GetComponent<MeshFilter>().mesh = CubeMesh;
			}
			else if (Shapelist.GetComponent<TMP_Dropdown>().value == 4)
			{
				LastSelTarget.GetComponent<descripter>().shape = "Sphere";
				LastSelTarget.GetComponent<MeshFilter>().mesh = SphereMesh;
			}
			else if (Shapelist.GetComponent<TMP_Dropdown>().value == 5)
			{
				LastSelTarget.GetComponent<descripter>().shape = "Cylinder";
				LastSelTarget.GetComponent<MeshFilter>().mesh = CylinderMesh;
			}
			else if (Shapelist.GetComponent<TMP_Dropdown>().value == 6)
			{
				LastSelTarget.GetComponent<descripter>().shape = "Pyramid";
				LastSelTarget.GetComponent<MeshFilter>().mesh = PyramedMesh;
			}
			else if (Shapelist.GetComponent<TMP_Dropdown>().value == 7)
			{
				LastSelTarget.GetComponent<descripter>().shape = "Prism";
				LastSelTarget.GetComponent<MeshFilter>().mesh = PrismMesh;
			}
		}

		public void typeinfochange()
		{
			float stable = float.Parse(StableText.text);
			float respawn = float.Parse(RespawnText.text);
			float stabletime = float.Parse(StableText.text);
			...
			if (Typelist.GetComponent<TMP_Dropdown>().value == 0)
			{
				LastSelTarget.GetComponent<descripter>().type = "DEFAULT";
				LastSelTarget.GetComponent<Renderer>().material = DefaultMat;
			}
			else if (Typelist.GetComponent<TMP_Dropdown>().value == 1)
			{
				LastSelTarget.GetComponent<descripter>().type = "GRABBABLE";
				LastSelTarget.GetComponent<Renderer>().material = GrabMat;
			}
			else if (Typelist.GetComponent<TMP_Dropdown>().value == 2)
			{
				LastSelTarget.GetComponent<descripter>().type = "ICE";
				LastSelTarget.GetComponent<Renderer>().material = IceMat;
			}
			else if (Typelist.GetComponent<TMP_Dropdown>().value == 3)
			{
				LastSelTarget.GetComponent<descripter>().type = "LAVA";
				LastSelTarget.GetComponent<Renderer>().material = LavaMat;
			}
			else if (Typelist.GetComponent<TMP_Dropdown>().value == 4)
			{
				LastSelTarget.GetComponent<descripter>().type = "WOOD";
				LastSelTarget.GetComponent<Renderer>().material = WoodMat;
			}
			else if (Typelist.GetComponent<TMP_Dropdown>().value == 5)
			{
				LastSelTarget.GetComponent<descripter>().type = "GRAPPLABLE";
				LastSelTarget.GetComponent<Renderer>().material = GrappableMat;
			}
			else if (Typelist.GetComponent<TMP_Dropdown>().value == 6)
			{
				LastSelTarget.GetComponent<descripter>().type = "GRAPPLABLE_LAVA";
				LastSelTarget.GetComponent<Renderer>().material = GrapLavaMat;
			}
			else if (Typelist.GetComponent<TMP_Dropdown>().value == 7)
			{
				LastSelTarget.GetComponent<descripter>().type = "GRABBABLE_CRUMBLING";
				LastSelTarget.GetComponent<descripter>().respawn_time = respawn;
				LastSelTarget.GetComponent<descripter>().stable_time = stabletime;
				LastSelTarget.GetComponent<Renderer>().material = CrumbleMat;
			}
			else if (Typelist.GetComponent<TMP_Dropdown>().value == 8)
			{
				LastSelTarget.GetComponent<descripter>().type = "DEFAULT_COLORED";
				LastSelTarget.GetComponent<Renderer>().material = DefaultColorMat;
			}
			else if (Typelist.GetComponent<TMP_Dropdown>().value == 9)
			{
				LastSelTarget.GetComponent<descripter>().type = "Sign";
				LastSelTarget.GetComponent<descripter>().shape = "Sign";
				LastSelTarget.GetComponent<descripter>().text = SignText.text;
				Debug.Log("Sign Called");
				LastSelTarget.GetComponent<Renderer>().material = WoodMat;
			}
			else if (Typelist.GetComponent<TMP_Dropdown>().value == 10)
			{
				LastSelTarget.GetComponent<descripter>().type = "finish";
				LastSelTarget.GetComponent<Renderer>().material = EndMat;
				LastSelTarget.name = "Finish";
			}
			else if (Typelist.GetComponent<TMP_Dropdown>().value == 11)
			{
				LastSelTarget.GetComponent<descripter>().type = "start";
				LastSelTarget.GetComponent<Renderer>().material = StartMat;
				LastSelTarget.name = "Start";
			}
		}
        ...
        public void InspectInfo()
        {
			...
			{
				var type = SelectedTarget.GetComponent<descripter>().type;
				var shape = SelectedTarget.GetComponent<descripter>().shape;

				//set typelist tmpro dropdown list to type
				if (type == "Sign")
				{
					Shapelist.GetComponent<TMP_Dropdown>().value = 2;
					Typelist.GetComponent<TMP_Dropdown>().value = 9;
					RespawnText.text = SelectedTarget.GetComponent<descripter>().respawn_time.ToString();
					StableText.text = SelectedTarget.GetComponent<descripter>().stable_time.ToString();
					RadiusText.text = SelectedTarget.GetComponent<descripter>().radius.ToString();
					SignText.text = SelectedTarget.GetComponent<descripter>().text;
				}
                else if (type == "GRABBABLE_CRUMBLING")
                {
					Typelist.GetComponent<TMP_Dropdown>().value = 7;
					RespawnText.text = SelectedTarget.GetComponent<descripter>().respawn_time.ToString();
					StableText.text = SelectedTarget.GetComponent<descripter>().stable_time.ToString();
					RadiusText.text = SelectedTarget.GetComponent<descripter>().radius.ToString();
					SignText.text = SelectedTarget.GetComponent<descripter>().text;
				}
				else if (type == "GRABBABLE")
                {
					Typelist.GetComponent<TMP_Dropdown>().value = 1;
					RespawnText.text = SelectedTarget.GetComponent<descripter>().respawn_time.ToString();
					StableText.text = SelectedTarget.GetComponent<descripter>().stable_time.ToString();
					RadiusText.text = SelectedTarget.GetComponent<descripter>().radius.ToString();
					SignText.text = SelectedTarget.GetComponent<descripter>().text;
                ...
                {
					Typelist.GetComponent<TMP_Dropdown>().value = 2;
					RespawnText.text = SelectedTarget.GetComponent<descripter>().respawn_time.ToString();
					StableText.text = SelectedTarget.GetComponent<descripter>().stable_time.ToString();
					RadiusText.text = SelectedTarget.GetComponent<descripter>().radius.ToString();
					SignText.text = SelectedTarget.GetComponent<descripter>().text;
				...
				{
					Typelist.GetComponent<TMP_Dropdown>().value = 3;
					RespawnText.text = SelectedTarget.GetComponent<descripter>().respawn_time.ToString();
					StableText.text = SelectedTarget.GetComponent<descripter>().stable_time.ToString();
					RadiusText.text = SelectedTarget.GetComponent<descripter>().radius.ToString();
					SignText.text = SelectedTarget.GetComponent<descripter>().text;
				...
				{
					Typelist.GetComponent<TMP_Dropdown>().value = 4;
					RespawnText.text = SelectedTarget.GetComponent<descripter>().respawn_time.ToString();
					StableText.text = SelectedTarget.GetComponent<descripter>().stable_time.ToString();
					RadiusText.text = SelectedTarget.GetComponent<descripter>().radius.ToString();
					SignText.text = SelectedTarget.GetComponent<descripter>().text;
				}
				else if (type == "GRAPPLABLE")
				{
					Typelist.GetComponent<TMP_Dropdown>().value = 5;
					RespawnText.text = SelectedTarget.GetComponent<descripter>().respawn_time.ToString();
					StableText.text = SelectedTarget.GetComponent<descripter>().stable_time.ToString();
					RadiusText.text = SelectedTarget.GetComponent<descripter>().radius.ToString();
					SignText.text = SelectedTarget.GetComponent<descripter>().text;
				}
				else if (type == "GRAPPLABLE_LAVA")
				{
					Typelist.GetComponent<TMP_Dropdown>().value = 6;
					RespawnText.text = SelectedTarget.GetComponent<descripter>().respawn_time.ToString();
					StableText.text = SelectedTarget.GetComponent<descripter>().stable_time.ToString();
					RadiusText.text = SelectedTarget.GetComponent<descripter>().radius.ToString();
					SignText.text = SelectedTarget.GetComponent<descripter>().text;
				}
				else if (type == "DEFAULT_COLORED")
				{
					Typelist.GetComponent<TMP_Dropdown>().value = 8;
					RespawnText.text = SelectedTarget.GetComponent<descripter>().respawn_time.ToString();
					StableText.text = SelectedTarget.GetComponent<descripter>().stable_time.ToString();
					RadiusText.text = SelectedTarget.GetComponent<descripter>().radius.ToString();
					SignText.text = SelectedTarget.GetComponent<descripter>().text;
				...
				{
					Typelist.GetComponent<TMP_Dropdown>().value = 11;
					RespawnText.text = SelectedTarget.GetComponent<descripter>().respawn_time.ToString();
					StableText.text = SelectedTarget.GetComponent<descripter>().stable_time.ToString();
					RadiusText.text = SelectedTarget.GetComponent<descripter>().radius.ToString();
					SignText.text = SelectedTarget.GetComponent<descripter>().text;
				...
				{
					Typelist.GetComponent<TMP_Dropdown>().value = 10;
					RespawnText.text = SelectedTarget.GetComponent<descripter>().respawn_time.ToString();
					StableText.text = SelectedTarget.GetComponent<descripter>().stable_time.ToString();
					RadiusText.text = SelectedTarget.GetComponent<descripter>().radius.ToString();
					SignText.text = SelectedTarget.GetComponent<descripter>().text;
				...
				{
					Typelist.GetComponent<TMP_Dropdown>().value = 0;
					RespawnText.text = SelectedTarget.GetComponent<descripter>().respawn_time.ToString();
					StableText.text = SelectedTarget.GetComponent<descripter>().stable_time.ToString();
					RadiusText.text = SelectedTarget.GetComponent<descripter>().radius.ToString();
					SignText.text = SelectedTarget.GetComponent<descripter>().text;
				...
				if (shape == "start")
                {
					Shapelist.GetComponent<TMP_Dropdown>().value = 0;
				}
				else if (shape == "finish")
				{
					Shapelist.GetComponent<TMP_Dropdown>().value = 1;
				}
				else if (shape == "Cube")
				{
					Shapelist.GetComponent<TMP_Dropdown>().value = 3;
				}
				else if (shape == "Sphere")
				{
					Shapelist.GetComponent<TMP_Dropdown>().value = 4;
				}
				else if (shape == "Cylinder")
				{
					Shapelist.GetComponent<TMP_Dropdown>().value = 5;
				}
				else if (shape == "Pyramid")
				{
					Shapelist.GetComponent<TMP_Dropdown>().value = 6;
				}
				else if (shape == "Prism")
				{
					Shapelist.GetComponent<TMP_Dropdown>().value = 7;
				}
			}
		}
        ...
        void MouseMovement()
        {
			...
			{
                //hide mouse and use mouse movement to rotate
                Cursor.visible = false;
                Cursor.lockState = CursorLockMode.Locked;

				//rotate with horizontal and vertical mouse movement
        ...
        void Movement()
        {
			//if holding right mouse and pressing w, move camera forward
			if (Input.GetMouseButton(1))
			{
				//if pressing w move forward if pressing s move back if pressing a move left if pressing d move right
		...
		void GetTarget()
		{
			if(nearAxis == Axis.None && Input.GetMouseButtonDown(0))
			{
				...
				if(Physics.Raycast(myCamera.ScreenPointToRay(Input.mousePosition), out hitInfo, Mathf.Infinity, selectionMask))
				{
					...
					{
						AddTarget(target);
						SelectedTarget = targetGameObject;
						LastSelTarget = SelectedTarget;
                        
                        this.name = SelectedTarget.name.ToString();
                    }
					else if(isRemoving)
					{
						RemoveTarget(target);
                        SelectedTarget = null;
                        this.name = LastSelTarget.name.ToString();
					}
